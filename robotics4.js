document.addEventListener('DOMContentLoaded', function() {
    // Lấy các phần tử DOM
    const previewBtn = document.getElementById('previewBtn4');
    const exportPdfBtn = document.getElementById('exportPdfBtn4');
    ...
    function calculateAverage() {
        ...
        const abilityGroups = ['ability1', 'ability2', 'ability3', 'ability4'];
        let totalScore = 0;
        let selectedCount = 0;
    ...
    async function generatePDF(courseName) {
        try {
            ...
            checkedRadios.forEach(radio => {
                ...
                if (label) {
                    label.style.backgroundColor = '#e7f5e7';
                    label.style.borderColor = '#e61e25';
                    label.textContent = '✓';
                }
            });
